...
public interface SpaceRepository extends JpaRepository<Space, Long> {
    ...
    List<Space> searchSpaces(String name, String location, LocalDate date, SpaceType type, Integer minPrice, Integer maxPrice, Integer minCapacity, Integer maxCapacity, Pageable pageable);
