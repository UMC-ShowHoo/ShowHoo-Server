...
public class JwtVerifyFilter extends OncePerRequestFilter {
    private static final String[] whitelist = {"/logout", "/kakao/logout/withAccount", "/login/oauth2/code/kakao", "/kakao", "/h2-console/**", "/swagger-ui/index.html", "/swagger-ui/**", "/v3/api-docs/**","/swagger-resources/**", "/v3/api-docs", "/spaces"};
